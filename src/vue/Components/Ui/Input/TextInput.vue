...
<template>
    <div :class="cn({ 'h-full w-full': props.type === 'textarea' })">
        <div
            :class="
                cn('relative', { 'h-full w-full': props.type === 'textarea' })
            "
        >
            <textarea
                v-if="type === 'textarea'"
            ...
            />
            <!-- custom icon -->
            <span class="absolute right-0 top-[50%] translate-y-[-50%] px-5">
                <slot name="custom_icon">
                    <span
                        @click="showPassword = !showPassword"
                        v-if="props.passwordInput"
                        type="button"
                        class="absolute right-0 top-[50%] translate-y-[-50%] cursor-pointer px-5"
                    >
                        <svg
                            v-if="showPassword"
